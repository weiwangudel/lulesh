...
void brgates_currents_1()  {
  ...
  for(Xstep = 1;Xstep<Nx+1;Xstep++) {  
   for (Ystep = 1; Ystep<Ny+1; Ystep++) {
    ...
    //Ix1 =
    datarr[1][3][Xstep][Ystep]= ((constarr[3]*Ix1t1) / (Ix1t2)) * (x1);     
    ...
    //INa = 
    datarr[1][5][Xstep][Ystep]=((constarr[1]) * block[Xstep][Ystep] * (pow((m),3.0))*(h))*(Vm-constarr[2]);     
    ...
    //Is = 
    datarr[1][8][Xstep][Ystep]=(constarr[4]) * block[Xstep][Ystep] * (d) * (f) * (Vm-(-82.3 - 13.0287 * log(Cai)));  

    Isum = (datarr[1][2][Xstep][Ystep]+ datarr[1][3][Xstep][Ystep] + datarr[1][5][Xstep][Ystep] + datarr[1][8][Xstep][Ystep]);           
    datarr[1][12][Xstep][Ystep]=Isum;  
    dVmdt = (datarr[1][13][Xstep][Ystep]) - (1/(constarr[5]))*(Isum-datarr[1][14][Xstep][Ystep]); 
...
/*****************************************************************************/
    ...
    Ix1t2 = exp(0.04*(Vm+35));
    //Ix1 = 
    datarr[0][3][Xstep][Ystep]=((constarr[3]*Ix1t1) / (Ix1t2)) * (x1);          
    ...
    //INa = 
    datarr[0][5][Xstep][Ystep]=((constarr[1]) * block[Xstep][Ystep] * (pow((m),3.0))*(h))*(Vm-constarr[2]); 
    ...
    //Is = 
    datarr[0][8][Xstep][Ystep]=(constarr[4]) * block[Xstep][Ystep] * (d) * (f) * (Vm-(-82.3 - 13.0287 * log(Cai)));        

    Isum = (datarr[0][2][Xstep][Ystep] +datarr[0][3][Xstep][Ystep] +datarr[0][5][Xstep][Ystep] +datarr[0][8][Xstep][Ystep]);
    datarr[0][12][Xstep][Ystep]=Isum;   
    dVmdt = (datarr[0][13][Xstep][Ystep]) - (1/(constarr[5]))*(Isum-datarr[0][14][Xstep][Ystep]);   
