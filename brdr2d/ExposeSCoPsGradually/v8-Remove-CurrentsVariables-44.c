...
void brgates_currents_1()  {
  ...
  for(Xstep = 1;Xstep<Nx+1;Xstep++) {  
   for (Ystep = 1; Ystep<Ny+1; Ystep++) {
    ...
    //INa = 
    datarr[1][5][Xstep][Ystep]=((constarr[1]) * block[Xstep][Ystep] * (pow((datarr[1][6][Xstep][Ystep]),3.0))*(datarr[1][7][Xstep][Ystep]))*(Vm-constarr[2]);     
    ...
    //Is = 
    datarr[1][8][Xstep][Ystep]=(constarr[4]) * block[Xstep][Ystep] * (datarr[1][9][Xstep][Ystep]) * (datarr[1][10][Xstep][Ystep]) * (Vm-(-82.3 - 13.0287 * log(datarr[1][11][Xstep][Ystep])));  
    ...
    Vm = Vm + ((datarr[1][1][Xstep][Ystep])*dt);     
...
/*****************************************************************************/
    ...
    //INa = 
    datarr[0][5][Xstep][Ystep]=((constarr[1]) * block[Xstep][Ystep] * (pow((datarr[0][6][Xstep][Ystep]),3.0))*(datarr[0][7][Xstep][Ystep]))*(Vm-constarr[2]); 
    ...
    //Is = 
    datarr[0][8][Xstep][Ystep]=(constarr[4]) * block[Xstep][Ystep] * (datarr[0][9][Xstep][Ystep]) * (datarr[0][10][Xstep][Ystep]) * (Vm-(-82.3 - 13.0287 * log(datarr[0][11][Xstep][Ystep])));        
    ...
    Vm = Vm + ((datarr[0][1][Xstep][Ystep])*dt);     
