...
void brgates_currents_1()  {
  ...
  for(Xstep = 1;Xstep<Nx+1;Xstep++) {  
   for (Ystep = 1; Ystep<Ny+1; Ystep++) {
    ...
    tx1 = 1 / (ax1+bx1);
    x1inf = ax1 * tx1;
    dx1dt = (x1inf - (datarr[0][4][Xstep][Ystep])) / tx1;
    ...
    tm = 1 / (am+bm);
    minf = am * tm;
    dmdt = (minf - (datarr[0][6][Xstep][Ystep])) / tm;
    ...
    th = 1 / (ah + bh);
    hinf = ah * th;
    dhdt = (hinf - (datarr[0][7][Xstep][Ystep])) / th;
    ...
    dinf = ad * td;
    dddt = (dinf - (datarr[0][9][Xstep][Ystep])) / td;
    ...
    finf = af * tf;
    dfdt = (finf - (datarr[0][10][Xstep][Ystep])) / tf;
...
void brgates_currents_2()  {
  ...
  for(Xstep = 1;Xstep<Nx+1;Xstep++){  
    ...
    tx1 = 1 / (ax1+bx1);
    x1inf = ax1 * tx1;
    dx1dt = (x1inf - (datarr[1][4][Xstep][Ystep])) / tx1;
    ...
    tm = 1 / (am+bm);
    minf = am * tm;
    dmdt = (minf - (datarr[1][6][Xstep][Ystep])) / tm;
    ...
    th = 1 / (ah + bh);
    hinf = ah * th;
    dhdt = (hinf - (datarr[1][7][Xstep][Ystep])) / th;
    ...
    td = (1 / (ad+bd)) * (constarr[11]);
    dinf = ad * td;
    dddt = (dinf - (datarr[1][9][Xstep][Ystep])) / td;
    ...
    tf = (1 / (af+bf)) * (constarr[11]);
    finf = af * tf;
    dfdt = (finf - (datarr[1][10][Xstep][Ystep])) / tf;
