...
#pragma omp parallel for private(c4, c3, c2, c1)
      for (c0 = 1; c0 <= Nx; c0++) {
        for (c1 = 0; c1 <= ((Ny * 256 < 0?((256 < 0?-((-Ny + 256 + 1) / 256) : -((-Ny + 256 - 1) / 256))) : Ny / 256)); c1++) {
  ...
  int jj;
            if (c2 == 0) {
              for (c3 = 0; c3 <= 1; c3++) {
                for (c4 = (1 > 256 * c1?1 : 256 * c1); c4 <= ((Ny < 256 * c1 + 255?Ny : 256 * c1 + 255)); c4++) {
...
{
{
    ...
    int c2;
    if (Nx >= 1 && Ny >= 1) {
#pragma omp parallel for private(c2, c1, c4, c3)
      for (c0 = 1; c0 <= Nx; c0++) {
        for (c1 = 0; c1 <= ((Ny * 256 < 0?((256 < 0?-((-Ny + 256 + 1) / 256) : -((-Ny + 256 - 1) / 256))) : Ny / 256)); c1++) {
          for (c2 = 0; c2 <= (((2 * c0 + 10) * 97 < 0?((97 < 0?-((-(2 * c0 + 10) + 97 + 1) / 97) : -((-(2 * c0 + 10) + 97 - 1) / 97))) : (2 * c0 + 10) / 97)); c2++) {
  double ax1;
...
#pragma simd
          for (c3 = (1 > 256 * c1?1 : 256 * c1); c3 <= ((Ny < 256 * c1 + 255?Ny : 256 * c1 + 255)); c3++) {
