...
#pragma omp parallel for private(c4, c3, c2, c1)
      for (c0 = 1; c0 <= Nx; c0++) {
        for (c1 = 0; c1 <= ((Ny * 1024 < 0?((1024 < 0?-((-Ny + 1024 + 1) / 1024) : -((-Ny + 1024 - 1) / 1024))) : Ny / 1024)); c1++) {
  ...
  int jj;
            if (c2 == 0) {
              for (c3 = 0; c3 <= 1; c3++) {
                for (c4 = (1 > 1024 * c1?1 : 1024 * c1); c4 <= ((Ny < 1024 * c1 + 1023?Ny : 1024 * c1 + 1023)); c4++) {
...
#pragma simd
          for (c3 = (1 > 1024 * c1?1 : 1024 * c1); c3 <= ((Ny < 1024 * c1 + 1023?Ny : 1024 * c1 + 1023)); c3++) {
